                    ...
                    <div className="grid-rows-2">
                        ...
                        >
                            <Link to={'/find/Nha Trang'} className="pt-52 flex pb-3 pl-3 mb-4">
                                <h1 className="px-3 rounded-xl bg-gray-100 bg-opacity-50 font-medium">Nha Trang</h1>
                            </Link>
                        </div>
                        <div
                            className="rounded-3xl shadow-lg"
                            ...
                            <Link to={'/place/' + doc.place._id} key={doc.place._id}>
                                <div className="border-2 p-4 rounded-xl shadow-lg">
                                    ...
                                    <div className="h-28">
                                        ...
                                        <h3 className="text-sm text-gray-500">{doc.place.address}</h3>
                                    </div>
                                    <div className="mt-1 flex justify-between">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <h1 className="font-semibold">{doc.rating.toPrecision(2)}</h1>
